...
<section class="hero-section" id="hero-section">
    ...
    <div class="content">
        <h1>Invest in the Heart of Karachi’s Rapidly Growing Zone </h1>
        <a href="./about-us.php">
...
<section class="advantage">
    <h1 class="theme-h1">Unaiza City’s Location Offers Unmatched Connectivity and Future Returns</h1>
    <p class="theme-para"><strong>Located at the Heart of Karachi’s Fastest Growing Corridor</strong>
        Unaiza City offers unmatched connectivity from every
    ...
    <div class="counter-grid">
        <div class="grid-item">
            <h3>15 Mins</h3>
            <p class="theme-para"> from Jinnah International Airport</p>
        </div>
        <div class="grid-item">
            <h3>25 Mins</h3>
...
<section class="masterpiece img-text">
    ...
    <img src="./assets/img/healthcare.jpg" alt="" class="order-2">
</section>
